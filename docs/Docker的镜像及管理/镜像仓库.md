...
好在许多第三方机构都提供了镜像站,不过这些镜像站也很容易就会失效.我习惯于在[coderjia](https://www.coderjia.cn/archives/dba3f94c-a021-468a-8ac6-e840f85867ea)上更新镜像站,通常一个月一更是一个比较稳妥的办法

配置镜像站的方法是修改配置文件中的`registry-mirrors`项:
