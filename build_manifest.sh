...
docker push dev.hszofficial.site:9443/stock/hellodocker:armv6-0.0.0
docker push dev.hszofficial.site:9443/stock/hellodocker:armv7-0.0.0
docker push dev.hszofficial.site:9443/stock/hellodocker:arm64-0.0.0
docker push dev.hszofficial.site:9443/stock/hellodocker:amd64-0.0.0
docker push dev.hszofficial.site:9443/stock/hellodocker:armv6-latest
docker push dev.hszofficial.site:9443/stock/hellodocker:armv7-latest
docker push dev.hszofficial.site:9443/stock/hellodocker:arm64-latest
docker push dev.hszofficial.site:9443/stock/hellodocker:amd64-latest
