...
docker push dev.hszofficial.site:9443/test/hello-docker:armv6-0.0.0 --disable-content-trust
...
docker push dev.hszofficial.site:9443/test/hello-docker:amd64-latest --disable-content-trust
